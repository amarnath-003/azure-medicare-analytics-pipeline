...
- [Project 1 — Olist E-Commerce Pipeline](https://github.com/amarnath-003/databricks-olist-pipeline) — Brazilian e-commerce dataset, Medallion Architecture baseline on Azure Databricks
